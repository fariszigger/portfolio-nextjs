    ...
    >
      ...
      className='flex w-full flex-col lg:flex-row items-center gap-20 my-20'>
        ...
        className='flex-1'>
            ...
            Hi, I'm Faris Zigger, a passionate frontend web developer from Indonesia. I specialize in building modern, user-friendly, and scalable applications using technologies like MERN, Laravel, and Next.js. With a strong focus on clean design and functionality, I aim to deliver high-quality solutions tailored to users' needs.
            </p>
